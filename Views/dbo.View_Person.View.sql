USE [s15guest38]
GO
/****** Object:  View [dbo].[View_Person]    Script Date: 4/23/2015 10:38:14 PM ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        P.First_Name, P.Last_Name, A.Street_1, A.Street_2, A.City, A.Zip, A.State_Country, P.Email, PPR.Role_id
FROM            dbo.Person AS P INNER JOIN
                         dbo.Address AS A ON P.Address_id = A.Address_id LEFT OUTER JOIN
                         dbo.PersonPresentationRole AS PPR ON P.Person_id = PPR.Person_id
